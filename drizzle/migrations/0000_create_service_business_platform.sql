...
VALUES (
  ...
  '2348000000000',
  'info@example.com',
  '1 Demo Close, Off Demo Road',
  'Ikeja',
  'Lagos',
  'Nigeria',
  'Demo Contracting Ltd — Solar, Painting & Epoxy Flooring',
  ...
  '© Demo Contracting Ltd. All rights reserved.'
);
...
VALUES ('Head Office','1 Demo Close, Off Demo Road','Ikeja','Lagos','Nigeria',6.6018,3.3515,'https://www.google.com/maps/search/?api=1&query=6.6018,3.3515',60,true,true);
...
INSERT INTO public.testimonials (customer_name, customer_company, customer_location, content, rating, is_demo, featured, published, sort_order) VALUES
 ('Sample Client A','Sample Company Ltd','Lagos','Demo content: placeholder testimonial used to preview layout. Replace or delete this from the admin dashboard.',5,true,true,true,1),
 ('Sample Client B','Sample Facility Management','Abuja','Demo content: placeholder testimonial used to preview layout. Replace or delete this from the admin dashboard.',5,true,false,true,2);
...
INSERT INTO public.site_content (key, value) VALUES
 ('homepage_hero','{"eyebrow":"Licensed Nigerian Contracting Company","headline":"Professional Solar, Painting & Flooring Solutions","subheadline":"We install, maintain and finish the systems and surfaces that keep homes, offices and industrial facilities running — delivered by supervised crews to a documented standard.","primary_cta":"Request a Quote","primary_cta_url":"/request-quote","secondary_cta":"Explore Our Services","secondary_cta_url":"/services","image_url":"","trust_points":["Supervised in-house crews","Documented testing & handover","Nationwide project delivery"]}'::jsonb),
 ('homepage_stats','{"items":[{"label":"Projects delivered","value":"250+"},{"label":"Years of experience","value":"10+"},{"label":"Service areas","value":"15+"},{"label":"Repeat clients","value":"90%"}],"note":"Demo figures — edit these in the admin dashboard."}'::jsonb),
