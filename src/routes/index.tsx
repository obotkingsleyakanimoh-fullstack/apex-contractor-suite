...
export function serviceFallback(slug?: string | null) {
  if (!slug) return "/images/commercial-project.webp";
  if (slug.includes("solar") || slug.includes("inverter")) return "/images/solar-installation.webp";
  if (slug.includes("electrical")) return "/images/electrical-works.webp";
  if (slug.includes("paint")) return "/images/painting-services.webp";
  if (slug.includes("epoxy")) return "/images/epoxy-flooring.webp";
  if (slug.includes("property") || slug.includes("building")) return "/images/property-improvement.webp";
  return "/images/commercial-project.webp";
}

export function projectFallback(slug?: string | null) {
  return serviceFallback(slug);
}
