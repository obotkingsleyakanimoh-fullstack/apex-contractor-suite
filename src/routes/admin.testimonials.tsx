...
function AdminTestimonials() {
  return (
    <CrudManager
      ...
      title="Testimonials"
      description="Only publish feedback you have actually received. Demo entries are labelled publicly."
      ...
      columns={[
        ...
        },
        {
          key: "is_demo",
          label: "Demo",
          render: (r) => <BoolBadge value={!!r.is_demo} yes="Demo" no="Real" />,
        },
      ]}
      defaults={{
        customer_name: "",
      ...
      fields={[
        ...
        { name: "is_demo", label: "Demo placeholder", type: "checkbox" },
