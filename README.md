...
==================================================
51. SEED / DEMO CONTENT

Create realistic demo content so the interface can be evaluated.
...
Clearly make demo content easy to replace/delete from the admin dashboard.

Do not present fabricated testimonials as real customer testimonials.

Label demo testimonials clearly if included.
